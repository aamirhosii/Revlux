  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Button title="Detailing Services" color="black" onPress={() => {navigation.navigate('DetailingServices')}} />
        <Button title="Home Services" color="black" onPress={() => {}} />
      </View>
      ...
      <View style={styles.bottomButtonContainer}>
        <Button title="Contact" color="black" onPress={() => navigation.navigate('Contact')} />
        <Button title="Account" color="black" onPress={() => navigation.navigate('Account')} />
